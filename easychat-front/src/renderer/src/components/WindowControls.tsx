    ...
    return (
      <div className={`window-controls window-controls--darwin ${className}`}>
        ...
        {showMinimize ? (
          ...
          >
            <svg width='12' height='12' viewBox='0 0 12 12'>
              <path d='M2 6h8a1 1 0 010 2H2a1 1 0 010-2z' fill='currentColor' />
            </svg>
          </button>
        ) : null}
    ...
    <div className={`window-controls window-controls--windows ${className}`}>
      {showMinimize ? (
        ...
        >
          <svg width='16' height='16' viewBox='0 0 16 16'>
            <path d='M4 8h8v1H4V8z' fill='currentColor' />
          </svg>
        </button>
      ) : null}
      ...
      {showMaximize ? (
        ...
        >
          {windowState.isMaximized ? (
            <svg width='16' height='16' viewBox='0 0 16 16'>
              <path d='M3 5v8h8V5H3zm1 1h6v6H4V6z M5 3h8v8h-1V4H5V3z' fill='currentColor' />
            </svg>
          ) : (
            <svg width='16' height='16' viewBox='0 0 16 16'>
              <path d='M3 3v10h10V3H3zm1 1h8v8H4V4z' fill='currentColor' />
            </svg>
          )}
        </button>
      ) : null}
