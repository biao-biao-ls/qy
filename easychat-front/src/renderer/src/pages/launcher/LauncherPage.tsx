...
const LauncherPage: React.FC = () => {
  ...
  // 处理环境选择
  const handleEnvironmentSelect = useCallback(async (envId: string) => {
  ...
  return (
    <ErrorBoundary>
      <div className={`launcher-page ${windowState.showBorder ? 'launcher-page--with-border' : ''}`}>
        {/* 标题栏 */}
        ...
        <div className="launcher-page__content">
          <div className="launcher-page__header">
            ...
            <p className="launcher-page__description">
              请选择 JLCONE 下单助手的运行环境
            </p>
          </div>
            ...
            {environments.map((env) => (
              ...
              >
                ...
                <div className="launcher-page__env-info">
                  ...
                  <div className="launcher-page__env-badge">
                    {env.name}
                  </div>
                </div>
          ...
          <div className="launcher-page__footer">
            <p className="launcher-page__help">
              如有疑问，请联系技术支持
            </p>
          </div>
        </div>
