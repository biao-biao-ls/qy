...
const SettingPage: React.FC = () => {
  ...
  const { preferences, updateLanguage, updateTheme, toggleAutoUpdate, toggleNotifications } = useUserPreferences()
  ...
  // 处理表单字段变化
  const handleFieldChange = useCallback(<K extends keyof SettingFormData>(
    field: K,
    value: SettingFormData[K]
  ) => {
    setFormData(prev => ({ ...prev, [field]: value }))
  }, [])

  // 处理嵌套字段变化
  const handleNestedFieldChange = useCallback(<T extends keyof SettingFormData>(
    parentField: T,
                ...
                <div className="setting-page__field">
                  <label className="setting-page__checkbox-label">
                    <input
                      ...
                      onChange={(e) => handleNestedFieldChange('notifications', 'orders', e.target.checked)}
                    />
                    <span>订单状态通知</span>
                  </label>
                </div>
                ...
                <div className="setting-page__field">
                  <label className="setting-page__checkbox-label">
                    <input
                      ...
                      onChange={(e) => handleNestedFieldChange('notifications', 'marketing', e.target.checked)}
                    />
                    <span>营销活动通知</span>
                  </label>
                </div>
                ...
                <div className="setting-page__field">
                  <label className="setting-page__checkbox-label">
                    <input
                      ...
                      onChange={(e) => handleNestedFieldChange('notifications', 'community', e.target.checked)}
                    />
                    <span>社区消息通知</span>
                  </label>
                </div>
