...
import { NotificationConfig, NotificationService } from '../services/NotificationService'
import { MessageStorageService, StorageConfig } from '../services/MessageStorageService'
import { ConnectionState, MessageType, PushMessage } from '../../types/push'
...
export class PushManager extends EventEmitter {
  ...
  private async deliverOfflineMessages(): Promise<void> {
    try {
      ...
      // 按时间顺序投递消息
      const sortedMessages = undeliveredMessages.sort(
